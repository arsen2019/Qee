    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={`absolute z-11 inset-x-0 bottom-0 w-full bg-[#003B71] text-white px-6 md:px-10 py-4
                ...
                >
                    ...
                    <div
                        className={`overflow-hidden z-11 mt-4 text-sm transition-all duration-500 ease-in-out custom-scrollbar
